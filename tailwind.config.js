    ...
    theme: {
        ...
        extend: {
            ...
            colors: {
                ...
                surface: 'rgb(var(--tint-mid) / <alpha-value>)',
                base: 'rgb(var(--tint-deep) / <alpha-value>)',
                ink: 'rgb(var(--c-ink) / <alpha-value>)',
                canvas: 'rgb(var(--c-bg) / <alpha-value>)',
                panel: 'rgb(var(--c-panel) / <alpha-value>)',
                sidebar: {
                    DEFAULT: 'rgb(var(--tint-deep) / <alpha-value>)',
                    foreground: 'rgb(var(--c-ink) / <alpha-value>)',
                    accent: 'rgb(var(--accent-rgb) / 0.11)',
                    'accent-foreground': 'rgb(var(--accent-rgb))',
                    border: 'rgb(var(--accent-rgb) / 0.20)',
                    ring: 'rgb(var(--accent-rgb))',
                    primary: 'rgb(var(--accent-rgb))',
                    'primary-foreground': 'rgb(var(--c-bg))',
                },
            },
            borderRadius: {
                lg: 'var(--radius)',
